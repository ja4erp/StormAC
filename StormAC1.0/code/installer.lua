...
RegisterCommand("stormac", function(source, args, rawCommand)
    if source == 0 then
        if args ~= nil then
            if args[1] == "install" then
                ...
                print("^2| [StormAC] | Aleatorio instalado en: ^3" .. RandomResource .. "  ^1No detenga este recurso!!!^7")
                print("^2| [StormAC] | Instalación completa^7")
                print("^2| [StormAC] | Su servidor se reiniciará en 40 segundos^7")
                print("^3| [StormAC] | Para desinstalar el anticheat ejecute el comando /uninstall^7")
                Citizen.Wait(40000)
                os.exit()
            ...
            elseif args[1] == "help" then
                print([[
                                        ...
                                        ^1//--StormAC--\\^0
^1------------------------------------------------------------------------------------------------------------------------^0
                    To install the anticheat run the command:                       ^2Stormac install^0
    
^1------------------------------------------------------------------------------------------------------------------------^0
                    To install the random resource run the command:                 ^2Stormac installrandom^0
    
^1------------------------------------------------------------------------------------------------------------------------^0
                    To uninstall the anticheat from the server, run the command:     ^2Stormac uninstall^0
...
^1------------------------------------------------------------------------------------------------------------------------^0
        ...
        print("^1| [StormAC] | ID: "..source.." You cannot run commands from the client side.^7")
    end
end)
        ...
        for resources = 0, GetNumResources() - 1 do
            ...
            if __Resource then
                ...
                if Rem then
                    ...
                    Wait(100)
                    os.remove(y)
                    print("^1Uninstalled the ^2" .. allresources .. " ^3resources\n^0")
                    a = a + 1
                end
            end
            if Fxmanifest then
                ...
                if Rem then
                    ...
                    Wait(100)
                    os.remove(y)
                    print("^1Uninstalled the ^2" .. allresources .. " ^3recursos\n^7")
                    a = a + 1
                end
            end
        end
        print("^1| [StormAC] | uninstalled the " .. a .. " resources^7")
        print("^3| [StormAC] | Delete string in resource and Fxmanifest^7")
        print("^3| [StormAC] | Please wait...^7")
    end)
end
...
function DisistallaStringeResource1()
    Citizen.CreateThread(function()
        ...
        print("^2| [StormAC] | Anticheat uninstall completed^7")
        print("^1| [StormAC] | Por favor reinicie el servidor^7")
    end)
end
